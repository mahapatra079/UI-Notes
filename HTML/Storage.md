...
- Local Storage can be compared to a filing cabinet where you can store important documents that you want to keep for a long time. You can access these documents whenever you need them,
  and they will remain safe even if you close the cabinet (browser).

- Session Storage can be compared to a whiteboard where you can jot down temporary notes during a meeting. Once the meeting is over and you erase the whiteboard (close the browser tab),
  all the notes are gone.
